...
export const updateUserAPI = async (userId, updateData) => {
  const response = await axios.put(
    `http://localhost:8080/api/account/update/${userId}`,
    updateData
  );
  return response.data;
};
...
export const GetAllInternalAPI = async () => {
  const response = await axios.get(
    `http://localhost:8080/api/account/internal`
  );
  return response.data;
};
export const fetchCountCustomerAPI = async () => {
  const response = await axios.get(
    `http://localhost:8080/api/account/count/customers`
  );
  return response.data;
};
export const GetAllCustomerAPI = async () => {
  const response = await axios.get(
    `http://localhost:8080/api/account/customers`
  );
  return response.data;
};
...
export const updateInternalAPI = async (UserId, updateData, requesterId) => {
  const response = await axios.put(
    `http://localhost:8080/api/account/update/internal/${UserId}`,
    updateData,
    {
      headers: {
        "requester-id": requesterId,
...
export const deleteUserAPI = async (UserId, requesterId) => {
  const response = await axios.delete(
    `http://localhost:8080/api/account/delete/${UserId}`,
    {
      headers: {
        "requester-id": requesterId,
      },
...
export const fetchCountCategoriesAPI = async () => {
  const response = await axios.get(
    `http://localhost:8080/api/categories/count`
  );
  return response.data;
};
...
export const fetchAllDiscountsAPI = async () => {
  const response = await axios.get(
    `http://localhost:8080/api/discount/products`
  );
  return response.data;
};
// Cart
...
export const fetchCartItemsAPI = async (accountId) => {
  const response = await axios.get(
    `http://localhost:8080/api/cart/${accountId}`
  );
  return response.data;
};
...
export const addToCartAPI = async (productId, quantity, accountId) => {
  const response = await axios.post(
    `http://localhost:8080/api/cart/add?productId=${productId}&quantity=${quantity}&accountId=${accountId}`
  );
  return response.data;
};
...
export const updateCartItemAPI = async (cartItemId, quantity) => {
  const response = await axios.put(
    `http://localhost:8080/api/cart/update/${cartItemId}?quantity=${quantity}`
  );
  return response.data;
};
...
export const fetchAllVoucherForAccountAPI = async (accountId) => {
  const response = await axios.get(
    `http://localhost:8080/api/vouchers/account/${accountId}`
  );
  return response.data;
};
export const fetchOneVoucherAPI = async (vouchers) => {
  const response = await axios.get(
    `http://localhost:8080/api/vouchers/${vouchersId}`
  );
  return response.data;
};
